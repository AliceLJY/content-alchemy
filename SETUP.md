...
> 💡 **什么是 submodule？** 简单说就是"项目中嵌套的项目"。我们用它来追踪外部依赖，这样你更新的时候不用手动去各个仓库拉代码。

### 当前追踪的依赖

| 依赖 | 路径 | 用途 |
|-----|------|------|
| **baoyu-skills** | `dependencies/baoyu-skills` | 微信公众号自动发布 |
| **nano-banana-pro** | `dependencies/nano-banana-pro` | 配图风格推荐库（6000+ prompts） |
